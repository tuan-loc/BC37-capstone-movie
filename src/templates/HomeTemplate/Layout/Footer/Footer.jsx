...
import { layDanhSachHeThongRapAction } from "redux/actions/actions";

const Footer = (props) => {
  const { heThongRapChieu } = useSelector((state) => state.reducer);
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            ...
            <ul className="space-y-1 list-none">
              <li>
                <NavLink
                  className="text-violet-100 no-underline"
                  rel="noopener noreferrer"
                  href="#"
                >
                  Features
          ...
          <div className="space-y-3">
            <h3 className="uppercase dark:text-gray-50">Đối tác</h3>
            ...
            <div className="flex justify-start space-x-3">
              ...
              >
                <svg
                  ...
                  fill="currentColor"
                  viewBox="0 0 32 32"
                  className="w-5 h-5 fill-current text-violet-100"
                >
